...
def test_reader_csv():
    ...
    assert read_transactions.reader_csv(os.path.join(DATA_PATH, "operations.json")) == [
        {"No": 131, "Yes": 50},
        {"No": 2, "Yes": 21},
    ]
...
def test_reader_excel():
    ...
    assert read_transactions.reader_excel(os.path.join(DATA_PATH, "operations.json")) == [
        {"No": 131, "Yes": 50},
        {"No": 2, "Yes": 21},
    ]
