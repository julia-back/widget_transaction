...
## Описание
Приложение для анализа транзакций, которые находятся в Excel-файле. Приложение сортирует и фильтрует транзакции по статусу, дате операции, валюте ключевым словам.
